...
//中文字符串编码
const unsigned char code F14x16[] = 
{  
...
/*****************************************************************************
 ...
 输入参数  : unsigned char ucIdxX  显示的横坐标0~122
             unsigned char ucIdxY  页范围0～7
             unsigned char ucData  显示的字符
 输出参数  : NONE
 返 回 值  : NONE
*****************************************************************************/
...
/*****************************************************************************
 ...
 输入参数  : unsigned char ucIdxX       显示的横坐标0~122
             unsigned char ucIdxY       页范围0～7
             unsigned char ucDataStr[]  显示的字符串
 输出参数  : NONE
 返 回 值  : NONE
*****************************************************************************/
...
/*****************************************************************************
 ...
 输入参数  : unsigned char ucIdxX       为显示的横坐标0~120
             unsigned char ucIdxY       为页范围0～3
             unsigned char ucDataStr[]  要显示的字符串
 输出参数  : NONE
 返 回 值  : NONE
*****************************************************************************/
...
/*****************************************************************************
 ...
 输入参数  : unsigned char ucIdxX       为显示的横坐标0~114
             unsigned char ucIdxY       为页范围0～3
             unsigned char ucDataStr[]  要显示的中文字符串
 输出参数  : NONE
 返 回 值  : NONE
*****************************************************************************/
...
/*****************************************************************************
 ...
 输入参数  : unsigned char ucIdxX    ucIdxX的范围为0～122
             unsigned char ucIdxY    ucIdxY的范围为0～7
...
/*****************************************************************************
 ...
 输入参数  : unsigned char ucIdxX ucIdxX的范围为0～120
             unsigned char ucIdxY ucIdxY为页的范围0～7
...
{
    unsigned int i, j, k, l, m, usData;  
    if(sData < 0)
    {
        LED_P6x8Char(ucIdxX,ucIdxY,'-');
        usData = (unsigned int)(-sData);  
    }
    else
    {
        LED_P6x8Char(ucIdxX,ucIdxY,'+');
...
/*****************************************************************************
 ...
 输入参数  : unsigned char *pucTable     二维图像数组的地址
             unsigned int usRowNum    二维图像的行数1~64
             unsigned int usColumnNum 二维图像的列数1~128
 输出参数  : none
 返 回 值  : none
*****************************************************************************/
void LED_PrintImage(unsigned char *pucTable, unsigned int usRowNum, unsigned int usColumnNum)
{
    ...
    LED_SetPos(0,(unsigned char)i); //设置剩下的行显示的起始坐标
    usRowTmp = i << 3;       //计算当前所在行的下标                  
    for(j = 0; j < usColumnNum; j++) //列扫描        
    {
        ucData = 0;
